...
export const Route = createRootRoute({
  ...
  head: () => {
    // Route-level SEO owns canonical/hreflang because only route loaders know
    // which site locales are actually published. The root shell must not emit
    // alternates from the global Paraglide locale list.
    return {
      meta: [
        { charSet: 'utf-8' },
